			...
			>
				<Grid container style={{ padding: '3vw' }}>
					...
					>
						...
						>
							It began as a tale but then gradually took shape to become one of the
							most sought after brands in Nigeria. Glow stopper was once an idea. The
							aim was to create an easy way for people to access quality products at
							affordable prices.
						</span>
						<Box
							style={{
